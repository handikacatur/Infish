                    ...
                    <table id="thisTable" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{$itemProgress->company_name}}</td>
                                <td class="text-center">{{$itemProgress->description}}</td>
                                <td class="text-center">{{$itemProgress->name}}</td>
                                <td class="text-center">
                                    <form action="{{url('/confirm-progress')}}/{{$itemProgress->id}}/progress" method="POST" class="m-auto text-center">
                                        @csrf
